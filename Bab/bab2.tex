...
Pada bagian ini, hanya dijelaskan mengenai teknik klasifikasi dan klustering.
...
\end{figure}
		...
		Terdapat 3 fase utama dan 1 fase yang opsional(bisa dijalankan atau tidak, bergantung pada kebutuha) pada MapReduce, yaitu fase \textit{map}, fase \textit{shuffle}, fase \textit{reduce}, dan fase \textit{combine}. 
		\begin{enumerate}
...
Pada gambar diatas, digambarkan bila terdapat dua buah node pada sebuah cluster. File dibagi menjadi dua block dimana pada block pertama data adalah data dengan key 0 dan 27, sedangkan pada block yang ke dua adalah data dengan key 16. Kedua block tersebut masuk ke dua buah node yang berbeda, lalu dilakukan fungsi map yang terpisah dan hasilnya disimpan sementara di masing-masing node tersebut.
